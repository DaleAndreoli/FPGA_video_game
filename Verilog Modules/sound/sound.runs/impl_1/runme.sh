...
HD_PWD='E:/Documents/School/ECEN 397/FGPA_video_game/sound/sound.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sound_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sound_top.tcl -notrace
