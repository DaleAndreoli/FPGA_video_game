...
HD_PWD='E:/Documents/School/ECEN 397/FGPA_video_game/sound/sound.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sound_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sound_top.tcl
