...
HD_PWD='E:/Documents/School/ECEN 397/FGPA_video_game/VGA/VGA.runs/clock_25MHz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_25MHz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clock_25MHz.tcl
