...
HD_PWD='E:/Documents/School/ECEN 397/FGPA_video_game/Game/Game.runs/VGA_PLL_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_PLL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_PLL.tcl
