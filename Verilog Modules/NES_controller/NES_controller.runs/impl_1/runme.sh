...
HD_PWD='E:/Documents/School/ECEN 397/FGPA_video_game/NES_controller/NES_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nes_controller_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nes_controller_top.tcl -notrace
