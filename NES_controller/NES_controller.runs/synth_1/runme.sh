...
HD_PWD='E:/Documents/School/ECEN 397/FGPA_video_game/NES_controller/NES_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nes_controller_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nes_controller_top.tcl
